...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-MacOSX/cudatest

dist/Release/GNU-MacOSX/cudatest: ${OBJECTFILES}
	${MKDIR} -p dist/Release/GNU-MacOSX
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cudatest ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/_ext/_DOTDOT/CUDA/HW06/src/main.o: nbproject/Makefile-${CND_CONF}.mk ../CUDA/HW06/src/main.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/CUDA/HW06/src/main.o ../CUDA/HW06/src/main.cpp

${OBJECTDIR}/_ext/_DOTDOT/CUDA/HW06/src/init.o: nbproject/Makefile-${CND_CONF}.mk ../CUDA/HW06/src/init.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/CUDA/HW06/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/CUDA/HW06/src/init.o ../CUDA/HW06/src/init.cpp

${OBJECTDIR}/_ext/_DOTDOT/CUDA/HW06/src/utils.o: nbproject/Makefile-${CND_CONF}.mk ../CUDA/HW06/src/utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/CUDA/HW06/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/CUDA/HW06/src/utils.o ../CUDA/HW06/src/utils.cpp

${OBJECTDIR}/_ext/_DOTDOT/CUDA/HW06/src/print.o: nbproject/Makefile-${CND_CONF}.mk ../CUDA/HW06/src/print.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/_DOTDOT/CUDA/HW06/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/CUDA/HW06/src/print.o ../CUDA/HW06/src/print.cpp
...
${OBJECTDIR}/_ext/_DOTDOT/CUDA/HW06/src/stopWatch/stopWatch.o: nbproject/Makefile-${CND_CONF}.mk ../CUDA/HW06/src/stopWatch/stopWatch.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/_DOTDOT/CUDA/HW06/src/stopWatch/stopWatch.o ../CUDA/HW06/src/stopWatch/stopWatch.cpp
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/GNU-MacOSX/cudatest
